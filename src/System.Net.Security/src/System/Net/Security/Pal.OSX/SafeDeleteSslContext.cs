...
namespace System.Net
{
    internal sealed class SafeDeleteSslContext : SafeDeleteContext
    {
        ...
        private static void SetProtocols(SafeSslHandle sslContext, SslProtocols protocols)
        {
            ...
            Interop.AppleCrypto.PAL_TlsProtocolId minProtocolId;
            Interop.AppleCrypto.PAL_TlsProtocolId maxProtocolId;

            switch (protocols & SupportedProtocols)
            {
                case SslProtocols.None:
                    // REVIEW: Give this a message.
                    throw new PlatformNotSupportedException();
                case SslProtocols.Tls:
                    minProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls10;
                    maxProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls10;
                    break;
                case SslProtocols.Tls11:
                    minProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls11;
                    maxProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls11;
                    break;
                case SslProtocols.Tls12:
                    minProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls12;
                    maxProtocolId = Interop.AppleCrypto.PAL_TlsProtocolId.Tls12;
                    break;
                ...
                case SslProtocols.Tls | SslProtocols.Tls11:
                    ...
                    break;
                default:
                    // REVIEW: Give this a message ("contiguous protocol versions", type of thing).
                    throw new PlatformNotSupportedException();
            }
